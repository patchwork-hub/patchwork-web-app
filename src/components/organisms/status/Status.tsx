      ...
      <div className="flex">
        ...
        >
          <div className="relative">
            <Image
              src={isValidImageUrl(data?.account?.avatar) ? data?.account?.avatar : FALLBACK_PREVIEW_IMAGE_URL}
              alt="avatar photo"
              width={40}
              height={40}
            ...
            {status.reblog && (
              <Image
                ...
                src={isValidImageUrl(status?.account?.avatar) ? status?.account?.avatar : FALLBACK_PREVIEW_IMAGE_URL}
                alt="avatar photo"
                width={24}
                height={24}
              />
